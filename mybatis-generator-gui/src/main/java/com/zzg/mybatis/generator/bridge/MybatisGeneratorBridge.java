...
public class MybatisGeneratorBridge {
    ...
    private static final boolean sql_mapper_all = false;
    ...
    public void generate() throws Exception {
        ...
        //////去除无用sql
        tableConfig.setCountByExampleStatementEnabled(sql_mapper_all);
        tableConfig.setDeleteByExampleStatementEnabled(sql_mapper_all);
        tableConfig.setSelectByExampleStatementEnabled(sql_mapper_all);
        tableConfig.setUpdateByExampleStatementEnabled(sql_mapper_all);
