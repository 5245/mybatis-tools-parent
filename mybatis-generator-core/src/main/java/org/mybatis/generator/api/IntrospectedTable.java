...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        //将deleteByPrimaryKey改为delete
        //将insertSelective改为insert
        //将selectByPrimaryKey改为select 
        //将updateByPrimaryKeySelective改为update
        setDeleteByPrimaryKeyStatementId("delete"); //$NON-NLS-1$
        setInsertSelectiveStatementId("insert"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("select"); //$NON-NLS-1$
